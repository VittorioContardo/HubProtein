...
<%
	...
	List<ProductBean> productsByName = (List<ProductBean>) session.getAttribute("products_by_name");
	String param = (String) session.getAttribute("parameter");
	if( productsByName == null || param == null ){
...
<html>
    ...
    <body>
        ...
        <div class="small-container">
            ...
            <div class="row">
            	<%
				Iterator<ProductBean> it = productsByName.iterator();
				while(it.hasNext()){
